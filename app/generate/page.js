...
const Generate = () => {
    ...
    return (
        <div className="bg-[#E9C0E9] min-h-[120vh] grid grid-cols-2"> {/*  we use min-h-[120vh] instead of fulll screeen */}
                ...
                <div className="flex flex-col gap-5 my-8">
                    ...
                    <div className="item">
                        ...
                        <div className="mx-4 flex flex-col">
                            ...
                            <button disabled={pic == "" || handle == "" || links[0].linktext == ""} onClick={()=>{submitLinks()}} className="disabled:bg-slate-500 p-5 py-2 mx-2 w-fit my-5 bg-slate-900 text-white font-bold rounded-3xl">Create your BitLink</button>
                        </div>
                    </div>
                </div>
            </div>
